/**
 * Pre-Sanity webinar/event catalogue seed snapshot.
 * Dates are preserved as-is, including intentional date-only placeholders.
 * Runtime must not import this file — use content/webinars.ts for chrome.
 */
